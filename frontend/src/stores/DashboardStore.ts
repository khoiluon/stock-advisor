...
export type DashboardActions = {
	...
	setIndicators: (indicators: DashboardState["indicators"]) => void;
	addMaLine: () => void;
...
export type StockDashboardStore = ReturnType<typeof createDashboardStore>;

export const createDashboardStore = (initProps?: Partial<DashboardState>) => {
	...
	return createStore<DashboardState & DashboardActions>()((set, get) => ({
		...DEFAULT_PROPS,
		...initProps,
