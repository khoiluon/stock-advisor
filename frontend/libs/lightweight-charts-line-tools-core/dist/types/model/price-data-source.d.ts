import { FirstValue, IPriceFormatter, IDataSource, AutoscaleInfo } from '../types';
 ...
 */
export declare abstract class PriceDataSource<HorzScaleItem> extends DataSource implements IDataSource {
    /**
     ...
     */
    constructor(model: IChartApiBase<HorzScaleItem>);
    /**
     ...
     */
    model(): IChartApiBase<HorzScaleItem>;
    /**
