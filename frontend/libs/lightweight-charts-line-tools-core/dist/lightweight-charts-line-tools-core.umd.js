(function (global, factory) {
    ...
    class LineToolsCorePlugin {
        constructor(chart, series, horzScaleBehavior) {
            ...
            this._selectDelegate = new Delegate();
         ...
         * @returns void
         */
        unsubscribeLineToolsSelect(handler) {
    ...
    function computeDashPattern(ctx, style) {
        switch (style) {
            case lightweightCharts.LineStyle.Solid: return [];
            case lightweightCharts.LineStyle.Dotted: return [ctx.lineWidth, ctx.lineWidth];
            case lightweightCharts.LineStyle.Dashed: return [2 * ctx.lineWidth, 2 * ctx.lineWidth];
            case lightweightCharts.LineStyle.LargeDashed: return [6 * ctx.lineWidth, 6 * ctx.lineWidth];
            case lightweightCharts.LineStyle.SparseDotted: return [ctx.lineWidth, 4 * ctx.lineWidth];
            default: return [];
        }
    }
    /**
