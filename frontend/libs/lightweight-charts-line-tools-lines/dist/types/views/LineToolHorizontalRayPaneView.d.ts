 ...
 */
export declare class LineToolHorizontalRayPaneView<HorzScaleItem> extends LineToolHorizontalLinePaneView<HorzScaleItem> {
    /**
     ...
     */
    constructor(source: LineToolHorizontalRay<HorzScaleItem>, // Use the specific model class for strong typing
