 ...
 */
export declare class LineToolRayPaneView<HorzScaleItem> extends LineToolTrendLinePaneView<HorzScaleItem> {
    /**
     ...
     */
    constructor(source: LineToolRay<HorzScaleItem>, // Use the specific model class for strong typing
