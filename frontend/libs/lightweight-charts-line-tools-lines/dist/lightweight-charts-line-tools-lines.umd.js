(function (global, factory) {
    ...
    class LineToolTrendLinePaneView extends lightweightChartsLineToolsCore.LineToolPaneView {
        ...
        _updateImpl(height, width) {
             ...
             */
            const cullingState = lightweightChartsLineToolsCore.getToolCullingState(points, this._tool, options.line.extend);
            let shouldCull = false;
            // 2. Apply Custom Culling Logic based on State and Extension Configuration
            switch (cullingState) {
                case lightweightChartsLineToolsCore.OffScreenState.OffScreenTop:
                    shouldCull = true;
                    break;
                case lightweightChartsLineToolsCore.OffScreenState.OffScreenBottom:
                    shouldCull = true;
                    break;
                case lightweightChartsLineToolsCore.OffScreenState.OffScreenLeft:
                    shouldCull = true;
                    break;
                case lightweightChartsLineToolsCore.OffScreenState.OffScreenRight:
                    shouldCull = true;
                    break;
                case lightweightChartsLineToolsCore.OffScreenState.FullyOffScreen:
                    shouldCull = true;
                    break;
                case lightweightChartsLineToolsCore.OffScreenState.Visible:
                default:
                    shouldCull = false;
                    break;
            }
    ...
    class LineToolHorizontalLinePaneView extends lightweightChartsLineToolsCore.LineToolPaneView {
        ...
        _updateImpl(height, width) {
            ...
            const cullingState = lightweightChartsLineToolsCore.getToolCullingState(points, this._tool, options.line.extend, singlePointOrientation);
            ...
            const segmentStart = new lightweightChartsLineToolsCore.AnchorPoint(startX, lineY, 0);
            const segmentEnd = new lightweightChartsLineToolsCore.AnchorPoint(endX, lineY, 0); // PointIndex doesn't matter here
    ...
    class LineToolVerticalLinePaneView extends lightweightChartsLineToolsCore.LineToolPaneView {
        ...
        _updateImpl(height, width) {
             ...
             */
            const cullingState = lightweightChartsLineToolsCore.getToolCullingState(points, this._tool, options.line.extend, { horizontal: false, vertical: true });
            if (cullingState !== lightweightChartsLineToolsCore.OffScreenState.Visible) {
             ...
             */
            const pTop = new lightweightChartsLineToolsCore.AnchorPoint(lineX, 0, 0); // P_Top (Y=0)
            const pBottom = new lightweightChartsLineToolsCore.AnchorPoint(lineX, paneDrawingHeight, 0); // P_Bottom (Y=paneHeight)
    ...
    class LineToolCrossLinePaneView extends lightweightChartsLineToolsCore.LineToolPaneView {
        ...
        _updateImpl(height, width) {
             ...
             */
            const cullingState = lightweightChartsLineToolsCore.getToolCullingState(points, this._tool, options.line.extend, { horizontal: true, vertical: true } // Dual infinite component
            );
            ...
            const pLeft = new lightweightChartsLineToolsCore.AnchorPoint(0, lineY, 0);
            const pRight = new lightweightChartsLineToolsCore.AnchorPoint(paneDrawingWidth, lineY, 0);
            /**
