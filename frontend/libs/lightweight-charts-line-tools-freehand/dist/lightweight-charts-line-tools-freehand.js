...
import { LineToolPaneView, PolygonRenderer, getToolBoundingBox, getToolCullingState, OffScreenState, AnchorPoint, PaneCursorType, LineCap, LineJoin, BaseLineTool, deepCopy, merge, ensureNotNull, FinalizationMethod } from 'lightweight-charts-line-tools-core';
 ...
 */
class LineToolBrushPaneView extends LineToolPaneView {
    /**
 ...
 */
class LineToolBrush extends BaseLineTool {
    ...
    constructor(coreApi, chart, series, horzScaleBehavior, options = {}, points = [], priceAxisLabelStackingManager) {
        const finalOptions = deepCopy(BrushOptionDefaults);
 ...
 */
class LineToolHighlighterPaneView extends LineToolPaneView {
    /**
 ...
 */
class LineToolHighlighter extends BaseLineTool {
    /**
     * Explicitly defines the highest valid index for an interactive anchor point.
     *
     ...
     */
    constructor(coreApi, chart, series, horzScaleBehavior, options = {}, points = [], priceAxisLabelStackingManager) {
        const finalOptions = deepCopy(HighlighterOptionDefaults);
        merge(finalOptions, options);
...
export { LineToolBrush, LineToolHighlighter, registerFreehandPlugin as default, registerFreehandPlugin };
//# sourceMappingURL=lightweight-charts-line-tools-freehand.js.map
