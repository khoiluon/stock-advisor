(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.LightweightChartsLineToolsFibRetracement = {}, global.LightweightCharts, global.LightweightChartsLineToolsCore));
     ...
     */
    class LineToolFibRetracementPaneView extends lightweightChartsLineToolsCore.LineToolPaneView {
        /**
        ...
        constructor(source, chart, series) {
             ...
             * @protected
             */
            this._primaryLineRenderer = new lightweightChartsLineToolsCore.SegmentRenderer(new lightweightChartsLineToolsCore.HitTestResult(lightweightChartsLineToolsCore.HitTestType.MovePoint));
            ...
            for (let i = 0; i < maxLevels; i++) {
                this._levelRenderers.push({
                    line: new lightweightChartsLineToolsCore.SegmentRenderer(new lightweightChartsLineToolsCore.HitTestResult(lightweightChartsLineToolsCore.HitTestType.MovePoint)),
                    rectangle: new lightweightChartsLineToolsCore.RectangleRenderer(),
                    label: new lightweightChartsLineToolsCore.TextRenderer(),
                });
            }
        }
        /**
        ...
        _updateImpl(height, width) {
             ...
             */
            const cullingState = lightweightChartsLineToolsCore.getToolCullingState(allLogicalPointsForCulling, this._tool, options.extend, undefined, cullingInfo);
            ...
            // --- CULLING END ---
            const lineOptions = {
                ...lightweightChartsLineToolsCore.deepCopy(options.line),
            ...
            for (let i = 0; i < levelsConfig.length; i++) {
                ...
                const P_TextLeftAnchor = new lightweightChartsLineToolsCore.AnchorPoint(X_left_of_pane, levelCoord, i);
                const P_TextRightAnchor = new lightweightChartsLineToolsCore.AnchorPoint(X_min_segment, levelCoord, i);
                const finalTextOptions = {
                    ...
                    alignment: lightweightChartsLineToolsCore.TextAlignment.Right,
                    font: {
                        family: 'sans-serif', size: 12, bold: false, italic: false,
                        color: config.color,
                    },
                    box: {
                        alignment: { horizontal: lightweightChartsLineToolsCore.BoxHorizontalAlignment.Right, vertical: lightweightChartsLineToolsCore.BoxVerticalAlignment.Middle },
                        padding: { x: 5, y: 3 },
                    }
                };
                /**
                ...
                let maxScreenX = Math.max(screenP0.x, screenP1.x);
                // Fix for vertical draws: if points are on the exact same X, 
                // provide a tiny vector so `extendAndClipLineSegment` knows it's a horizontal line and extends it.
                if (minScreenX === maxScreenX) {
                    maxScreenX += 1;
                }
                const lineStart = new lightweightChartsLineToolsCore.AnchorPoint(options.extend.left ? 0 : minScreenX, levelCoord, i);
                const lineEnd = new lightweightChartsLineToolsCore.AnchorPoint(options.extend.right ? paneDrawingWidth : maxScreenX, levelCoord, i);
                /**
                ...
                if (i > 0) {
                    ...
                    if (prevConfig.opacity > 0) {
                        ...
                        const rectPoint1 = new lightweightChartsLineToolsCore.AnchorPoint(minScreenX, rectMinY, 0);
                        const rectPoint2 = new lightweightChartsLineToolsCore.AnchorPoint(maxScreenX, rectMaxY, 1);
                        /**
                        ...
                        levelRendererSet.rectangle.setData({
                            ...
                            border: { width: 0, style: lightweightCharts.LineStyle.Solid, radius: 0 },
                            extend: options.extend,
     ...
     */
    class LineToolFibRetracement extends lightweightChartsLineToolsCore.BaseLineTool {
        /**
        ...
        constructor(coreApi, chart, series, horzScaleBehavior, options = {}, points = [], priceAxisLabelStackingManager) {
            ...
            const finalOptions = lightweightChartsLineToolsCore.deepCopy(FibRetracementOptionDefaults);
        ...
        getShiftConstrainedPoint(pointIndex, rawScreenPoint, phase, originalLogicalPoint, allOriginalLogicalPoints) {
            ...
            return {
                point: new lightweightChartsLineToolsCore.Point(rawScreenPoint.x, referenceScreenPoint.y),
                snapAxis: 'price',
            };
        }
        /**
    ...
    exports.LineToolFibRetracement = LineToolFibRetracement;
    exports.default = registerFibRetracementPlugin;
    exports.registerFibRetracementPlugin = registerFibRetracementPlugin;

    Object.defineProperty(exports, '__esModule', { value: true });

}));
//# sourceMappingURL=lightweight-charts-line-tools-fib-retracement.umd.js.map
