(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.LightweightChartsLineToolsLongShortPosition = {}, global.LightweightCharts, global.LightweightChartsLineToolsCore));
     ...
     */
    class LineToolLongShortPositionPaneView extends lightweightChartsLineToolsCore.LineToolPaneView {
        /**
        ...
        constructor(tool, chart, series) {
             ...
             * @protected
             */
            this._riskRenderer = new lightweightChartsLineToolsCore.RectangleRenderer();
            /**
             * Internal renderer for the Profit Target (Reward) rectangle.
             * @protected
             */
            this._rewardRenderer = new lightweightChartsLineToolsCore.RectangleRenderer();
            /**
             * Internal renderer for the text statistics in the Risk zone.
             * @protected
             */
            this._riskLabelRenderer = new lightweightChartsLineToolsCore.TextRenderer();
            /**
             * Internal renderer for the text statistics in the Reward zone.
             * @protected
             */
            this._rewardLabelRenderer = new lightweightChartsLineToolsCore.TextRenderer();
        }
        /**
        ...
        _updateImpl(height, width) {
             ...
             */
            const fixedWidth = 150; // Use a fixed arbitrary width if the timestamps match
            let pStopScreen = P_Stop_Screen;
            if (P_Entry_Screen.x === P_Stop_Screen.x) {
                // Offset to the right by fixedWidth if they are exactly vertically aligned
                pStopScreen = { x: (P_Entry_Screen.x + fixedWidth), y: P_Stop_Screen.y };
            }
            const riskPoints = [P_Entry_Screen, pStopScreen];
            this._riskRenderer.setData({
                ...lightweightChartsLineToolsCore.deepCopy(options.entryStopLossRectangle),
                points: riskPoints,
            ...
            if (P_PT_Screen) {
                let ptScreenModified = P_PT_Screen;
                if (P_Entry_Screen.x === P_PT_Screen.x && P_Entry_Screen.x === P_Stop_Screen.x) {
                    // Also use the fixed width for the PT box
                    ptScreenModified = { x: (P_Entry_Screen.x + fixedWidth), y: P_PT_Screen.y };
                }
                const rewardPoints = [P_Entry_Screen, ptScreenModified];
                /**
                ...
                this._rewardRenderer.setData({
                    ...lightweightChartsLineToolsCore.deepCopy(options.entryPtRectangle),
                    points: rewardPoints,
                    hitTestBackground: false,
                });
            ...
            if (options.showAutoText) {
                ...
                const finalRiskTextOptions = lightweightChartsLineToolsCore.merge(lightweightChartsLineToolsCore.deepCopy(defaultAutoTextStyle), options.entryStopLossText);
                ...
                if (finalRiskTextOptions.box.alignment.vertical === lightweightChartsLineToolsCore.BoxVerticalAlignment.Middle) {
                    finalRiskTextOptions.box.alignment.vertical = isLong ? lightweightChartsLineToolsCore.BoxVerticalAlignment.Bottom : lightweightChartsLineToolsCore.BoxVerticalAlignment.Top;
                }
                /**
                ...
                if (P_PT_Screen && P2_logical) {
                    ...
                    // A. Merge Defaults + User Options
                    const finalRewardTextOptions = lightweightChartsLineToolsCore.merge(lightweightChartsLineToolsCore.deepCopy(defaultAutoTextStyle), options.entryPtText);
                    // B. Set Dynamic Text (Preserving User Note)
                    ...
                    if (finalRewardTextOptions.box.alignment.vertical === lightweightChartsLineToolsCore.BoxVerticalAlignment.Middle) {
                        finalRewardTextOptions.box.alignment.vertical = isLong ? lightweightChartsLineToolsCore.BoxVerticalAlignment.Top : lightweightChartsLineToolsCore.BoxVerticalAlignment.Bottom;
                    }
        ...
        _addAnchors(renderer) {
            ...
            entryAnchor.specificCursor = lightweightChartsLineToolsCore.PaneCursorType.VerticalResize;
            stopAnchor.specificCursor = lightweightChartsLineToolsCore.PaneCursorType.VerticalResize;
            ptAnchor.specificCursor = lightweightChartsLineToolsCore.PaneCursorType.VerticalResize;
            renderer.append(this.createLineAnchor({
                points: [entryAnchor, stopAnchor, ptAnchor],
                defaultAnchorHoverCursor: lightweightChartsLineToolsCore.PaneCursorType.VerticalResize,
                defaultAnchorDragCursor: lightweightChartsLineToolsCore.PaneCursorType.VerticalResize,
            }, 0));
        }
        /**
        ...
        _isRectangleVisible(pA, pB, rectOptions) {
            ...
            const cullingState = lightweightChartsLineToolsCore.getToolCullingState(cullingPoints, this._tool, extendOptions, undefined, cullingInfo);
            // 4. Interpret State
            ...
            return cullingState === lightweightChartsLineToolsCore.OffScreenState.Visible;
        }
    }
    ...
    const LongShortPositionOptionDefaults = {
        ...
        entryStopLossRectangle: {
            ...
            border: { width: 1, style: lightweightCharts.LineStyle.Solid, color: 'red', radius: 0 },
            extend: { left: false, right: false },
        },
        entryPtRectangle: {
            background: { color: 'rgba(0, 128, 0, 0.2)' },
            border: { width: 1, style: lightweightCharts.LineStyle.Solid, color: 'green', radius: 0 },
            extend: { left: false, right: false },
        },
        entryStopLossText: {
            value: '',
            ...
            alignment: lightweightChartsLineToolsCore.TextAlignment.Left,
            font: {
     ...
     */
    class LineToolLongShortPosition extends lightweightChartsLineToolsCore.BaseLineTool {
        /**
        ...
        constructor(coreApi, chart, series, horzScaleBehavior, options = {}, points = [], priceAxisLabelStackingManager) {
            const finalOptions = lightweightChartsLineToolsCore.deepCopy(LongShortPositionOptionDefaults);
        ...
        getAutoTextBaseOptions() {
            ...
            return lightweightChartsLineToolsCore.deepCopy(currentOptions.entryStopLossText);
        }
        /**
        ...
        _updateAndNormalizeToolState() {
            ...
            const isLong = lightweightChartsLineToolsCore.ensureNotNull(this._isLong);
        ...
        getShiftConstrainedPoint(pointIndex, rawScreenPoint, phase, originalLogicalPoint, allOriginalLogicalPoints) {
            ...
            // not during Creation.
            if (phase !== lightweightChartsLineToolsCore.InteractionPhase.Editing) {
                return result;
            }
            ...
            if (pointIndex === 0 || pointIndex === 1) {
                ...
                if (lockedScreenY !== null) {
                    return {
                        ...
                        point: new lightweightChartsLineToolsCore.Point(rawScreenPoint.x, lockedScreenY),
    ...
    exports.LineToolLongShortPosition = LineToolLongShortPosition;
    exports.default = registerLongShortPositionPlugin;
    exports.registerLongShortPositionPlugin = registerLongShortPositionPlugin;

    Object.defineProperty(exports, '__esModule', { value: true });

}));
//# sourceMappingURL=lightweight-charts-line-tools-long-short-position.umd.js.map
